...
constant_widgets = {}
variables = {}
DEFAULT_SKIN = "SATtek-EleganceBLUE/skin.xml"
...
try:
	if config.skin.primary_skin.value == "SATtek-EleganceBLUE/skin.xml" or config.skin.primary_skin.value == DEFAULT_SKIN:
		cachemenu()
except:
